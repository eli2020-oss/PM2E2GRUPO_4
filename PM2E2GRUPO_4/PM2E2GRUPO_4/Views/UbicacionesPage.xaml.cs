...
namespace PM2E2GRUPO_4.Views
{
    ...
    public partial class UbicacionesPage : ContentPage
    {
        ...
        public async void CollectionView_SeletionChangedEventHandler(object sender, SelectionChangedEventArgs e)
        {
            var ubicaciones = e.CurrentSelection[0] as Ubicaciones;
            if (ubicaciones == null) return;
            await Navigation.PushAsync(new UbicacionesDetailsPage(ubicaciones));
